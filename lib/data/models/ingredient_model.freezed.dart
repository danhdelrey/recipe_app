...
@JsonKey(name: 'idIngredient') String get id;@JsonKey(name: 'strIngredient') String get name;@JsonKey(name: 'strDescription') String? get description;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IngredientModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description));
}
...
@override
String toString() {
  return 'IngredientModel(id: $id, name: $name, description: $description)';
}
...
@useResult
$Res call({
@JsonKey(name: 'idIngredient') String id,@JsonKey(name: 'strIngredient') String name,@JsonKey(name: 'strDescription') String? description
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'idIngredient')  String id, @JsonKey(name: 'strIngredient')  String name, @JsonKey(name: 'strDescription')  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IngredientModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'idIngredient')  String id, @JsonKey(name: 'strIngredient')  String name, @JsonKey(name: 'strDescription')  String? description)  $default,) {final _that = this;
switch (_that) {
case _IngredientModel():
return $default(_that.id,_that.name,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'idIngredient')  String id, @JsonKey(name: 'strIngredient')  String name, @JsonKey(name: 'strDescription')  String? description)?  $default,) {final _that = this;
switch (_that) {
case _IngredientModel() when $default != null:
return $default(_that.id,_that.name,_that.description);case _:
  return null;
...
class _IngredientModel extends IngredientModel {
  const _IngredientModel({@JsonKey(name: 'idIngredient') required this.id, @JsonKey(name: 'strIngredient') required this.name, @JsonKey(name: 'strDescription') required this.description}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IngredientModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description));
}
