...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AreaEntity&&(identical(other.name, name) || other.name == name));
}
...
class _AreaEntity implements AreaEntity {
  const _AreaEntity({required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AreaEntity&&(identical(other.name, name) || other.name == name));
}
